    ...
    <div class="card-body row">
        ...
        <div class="form-group col-sm-12 col-md-6">
            ...
            <select name="content_3" class="form-control select2">
                <option value="Actualidad" @if($post->content_3 == 'Actualidad') checked @endif>Actualidad</option>
                <option value="Empresa" @if($post->content_3 == 'Empresa') checked @endif>Empresa</option>
                <option value="Productos" @if($post->content_3 == 'Productos') checked @endif>Productos</option>
            </select>
        </div> 
        @if ($post->content_4)
        ...
        <div class="form-group col-sm-12 col-md-4 ">
            ...
            @endif
            <label>imagen <small>imagen 792x428px</small></label>
